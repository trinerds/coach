...
This document tracks support tickets that are valid product ideas but should not stay in the engineering bug backlog.

It exists so we can:

- keep bug triage focused on defects and regressions
- preserve user-requested product ideas instead of losing them in closed support tickets
- give support and product a lightweight place to review demand clusters later
...
These are not feature requests, but they also should not sit in the engineering bug queue.

| Ticket                                 | Title                                                                      | Reason                                                                                             |
| -------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `9f3975a4-55fd-40c5-a757-d420a95e9424` | Account Deletion Request                                                   | Support/account operation request.                                                                 |
| `b20dbdce-f330-4c1b-ba9e-1b0effad4806` | Account Deactivation Request                                               | Support/account operation request.                                                                 |
| `0686046e-ac48-4411-b7fe-0783ee13e410` | Problème de synchronisation des activités depuis Garmin (Toutes activités) | Current state points to reconnect/support follow-up rather than an active core engineering defect. |

## Notes

- Closing the original support ticket does not mean the idea is rejected.
- This tracker is the handoff point for later product review, prioritization, or consolidation.
- If we later adopt a dedicated product-request board, these entries should move there with the ticket IDs preserved.
